...
when 'installer'
  ...
  default['confluence']['checksum'] =
    ...
    when '5.4.3' then node['confluence']['arch'] == 'x64' ? '40ec3b23d1c47dae0b2b39ae32129208ef631940e43d9ae13d3da341e2f1c9c8' : '960b3a2091948ff17e6a42a2c270445a69ed47b63fc8d2e9c460022e04718b8e'
    when '5.4.4' then node['confluence']['arch'] == 'x64' ? 'e82fc4197894ba53f9cbcab1d0158a01727e1def1d348932843375ad2994da0b' : '80008170cfcf9dcc6b61dfb14a0baa948134439e45f8ed784e3858eba3dda802'
...
when 'standalone'
  ...
  default['confluence']['checksum'] =
    ...
    when '5.4.3' then '51b74ff3cd22a26226ea6fa1da13833624263afc18601719f5f5f545b4b100ca'
    when '5.4.4' then '51c6ee75e3f6109960856700a4e3adfa4d6dc8ce63b6dbeac95a8f22f0ae66e9'
